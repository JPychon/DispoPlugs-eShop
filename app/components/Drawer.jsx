        ...
        <div className="fixed inset-0">
          <div className="absolute inset-0 overflow-hidden">
            ...
            >
              ...
              >
                <Dialog.Panel className="w-screen max-w-lg text-left align-middle transition-all transform shadow-xl h-screen-dynamic bg-clear_contrast">
                  <header
