            ...
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <a href="https://disposablesplug.com" className="flex items-center">
                      <img src="https://i.ibb.co/0nJ8dXz/disposables-plug-high-resolution-logo-color-on-transparent-background.png" className="h-8 mr-3" alt="DisposablesPlug Logo" />
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400 font-medium">
                          <li className="mb-4">
                              <a href="https://disposablesplug.com" className="hover:underline">About Us</a>
                          </li>
                          <li>
                              <a href="https://disposablesplug.com" className="hover:underline">Contact</a>
                          </li>
                      </ul>
                  </div>
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400 font-medium">
                          <li className="mb-4">
                              <a href="https://disposablesplug.com" className="hover:underline ">FAQ</a>
                          </li>
                          <li>
                              <a href="https://disposablesplug.com" className="hover:underline">Return Policy</a>
                          </li>
                      </ul>
                  </div>
                  <div>
