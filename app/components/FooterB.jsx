    ...
    <footer className="grid bg-primary dark:bg-primary text-gray-700 items-start grid-flow-row w-full inset-x-0 bottom-0">
        <div className="mx-auto w-full px-12 lg:py-2">
            <div className="md:flex md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 lg:mt-10 mb-2 lg:grid-cols-4">
                    <div>
                    ...
                    <div className='lg:flex lg:justify-center lg:content-center lg:h-24'>
            ...
            <div className="sm:flex sm:items-center sm:justify-between sm:mb-4 md:mb-4">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 mb-4">
                    <a href="#" className="text-lightGray hover:text-gray-900 dark:hover:text-white">
